...
//******************************************************************************
        ...
        DatoEnviado = Temperatura*1;                    //convertimos temperatura a float
        sprintf(Valor, "%0.0d,%0.0d,%0.0d,", DatoEnviado, DatoEnviado, DatoEnviado); 
        UART_Write_Text(Valor);                         //Enviamos la temperatura 
